...
<div class="container">
  <div class="row">
    <table class="table table-striped">
        ...
        <tr>
          <th colspan="5">
              <a href="#" data-toggle="modal" data-target="#myModalCadastrarQuarto">
        ...
        <tr>
            ...
            <td><?php print $rowQuarto['status'] ?></td>
            <td><?php print $rowQuarto['valor'] ?></td>
            <td>
                <a href="#">
                    <span class="glyphicon glyphicon-pencil"
                    data-toggle="modal" data-target="#myModalEditarQuarto"
                    data-quartoid="<?php print $rowQuarto['id'] ?>"
                    data-quartodescricao="<?php print $rowQuarto['descricao'] ?>"
                    data-quartostatus="<?php print $rowQuarto['status'] ?>"
                    data-quartovalor="<?php print $rowQuarto['valor'] ?>">
                    </span>
                </a>
            </td>
            <td>
...
<div id="myModalCadastrarQuarto" class="modal fade" role="dialog">
...
<!-- Modal Editar Quarto -->
<div id="myModalEditarQuarto" class="modal fade" role="dialog">
  <div class="modal-dialog">
...
<!-- Modal FIM Editar Quarto -->

<script>
  $('#myModalEditarQuarto').on('show.bs.modal', function(event){
      var button = $(event.relatedTarget)
      var recipientid = button.data('quartoid'); 
      var recipientdescricao = button.data('quartodescricao');
      var recipientstatus = button.data('quartostatus');
      var recipientvalor = button.data('quartovalor');

      var modal = $(this)
      modal.find('.modal-title').text('Editar Quarto');
      modal.find('#recipient-id').val(recipientid);
      modal.find('#txtDescricao').val(recipientdescricao);
      modal.find('#txtStatus').val(recipientstatus);
